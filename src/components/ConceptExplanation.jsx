export default function ConceptExplanation() {
  return (
    ...
    <section class="bg-dark12 py-8 text-gray-500 body-font">
          ...
          <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div class="flex relative pb-12">
              ...
              <div class="flex-grow pl-4">
                <h2 class="font-medium title-font text-sm text-gray-300 mb-1 tracking-wider">
                  STEP 1
                </h2>
            ...
            <div class="flex relative">
              ...
              <div class="flex-grow pl-4">
                ...
                <p class="leading-relaxed">
                  The claims that make it to this stage, will be considered{" "}
                  <span className="text-emerald-400">factual</span>, and{" "}
                  <span className="text-emerald-400">true</span> with a degree
                  of certainness that it didn't have before the process.
                </p>
              </div>
            </div>
          </div>
